...
Infine come nota finale, aggiungiamo che il campo delle funzioni modulari di peso $0$ è $\bbC(j)$. Ciò corrisponde al fatto che le funzioni meromorfe sulla sfera di Riemann sono $\bbC(x)$, letto attraverso il biolomorfismo $j : F \cup \{ \infty \} \rightarrow \hat \bbC$.

Zannier consiglia la parte sulle funzioni modulari del Serre, ``A course in Arithmetic'' o il libro di Zagier, ``The 1-2-3 of Modular Forms''.
