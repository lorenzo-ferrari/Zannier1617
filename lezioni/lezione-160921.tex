...
% \curvegraph{y**2 - x**3 - x**2}{[-2:2]}{[-2:2]} % fails online compilation!
\begin{center}
	\begin{tikzpicture}
		\begin{axis}[axis equal, xmin=0, xmax=2, ymin=-1.5, ymax=1.5, xlabel={ x }, ylabel={ y }] % parametric plot: x = t^2, y = t^3 (covers both branches; x >= 0)
		\addplot[domain=-1.5:1.5, samples=400, variable=\t, thick] ({\t*\t}, {\t*\t*\t});
		\end{axis}
	\end{tikzpicture}
\end{center}
