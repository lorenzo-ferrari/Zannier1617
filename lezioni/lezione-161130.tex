\thislesson{30 Novembre 2016}{Collegamenti tra tori e curve ellittiche}
	...
	Prendo $f(t) = t^3 + a t + b$. Essendo $D_t$ di grado 6 nei coefficienti, deve essere combinazione linerare di $a^3$ e $b^2$. Ora mettendomi nel caso particolare $a = 0, B = -1$ e nel caso $B = 0$ posso agilmente scoprire che 
	\[
		D_t = -4a^3 - 27b^2
	\]
