...
A sinistra ho $\ord_{z_0}( \wp'^2) = 2\ord_{z_0}( \wp') = 2(m-1)$. A destra ho $\ord_{z_0}(RHS) = 2m + \ord_{z_0}(a\wp+b) \ge 2m$, perchè $a \wp(z_0)+b = ac+b \neq \infty$. Ma $2m> 2(m-1)$, assurdo.
\end{proof}
...
$$ 0 = \wp'(x)^2 = A(\wp(x))$$
che $\wp(x)$ è uno zero di $A$, come desiderato.
\end{proof}
...
\wp(z) & = & \frac{1}{z^2} + \sum_{\omega \in L^*} \frac{1}{\omega^2} \frac{1}{(1-z/\omega)^2} - \frac{1}{\omega^2} = \\
       & = & \frac{1}{z^2} + \sum_{\omega \in L^*} \frac{1}{\omega^2} \sum_{k \ge 1} (k+1) \left ( \frac{z}{\omega} \right ) ^k =  \qquad \text{attenzione al $k = 0$ !}\\
...
\wp'(z)^2 & = & \left ( \frac{-2}{z^3} + zg(z) \right )^2 = \\
          & = & \frac{4}{z^6} -4\frac{g(z)}{z^2} + z^2g^2(z) = \qquad \text{ il termine in } z^2 \text{ è } O(z)\\
...
\wp(z)^2  & = & \left ( \frac{1}{z^2} + z^2f(z) \right )^2 = \\
          & = & \frac{1}{z^4} +2f(z) + z^4f^2(z) = \qquad \text{ il termine in } z^4 \text{ è } O(z)\\
          & = & \frac{1}{z^4} + 6s_4 + O(z) \\
