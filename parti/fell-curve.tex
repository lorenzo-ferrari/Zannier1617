...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{osservazione}
      ...
      Infatti nella parametrizzazione di Weierstrass, si ha che $x = \wp(z)$ e $y = \wp'(z)$. Allora, chiamata $g: E \rar \bbC$ l'inversa della parametrizzazione si ha che $g_*(\frac{\de x}{y}) = \frac{\de(\wp(z))}{\wp'(z)} = \frac{\wp'(z) \de z}{\wp'(z)} = \de z$.
...
\end{itemize}
	...
	Convenzionalmente, invece dell'ovvia $c=1$ si pone $c=1728$ per motivi aritmetici.
