...
Questo esempio dà molti spunti interessanti e cercheremo di estenderlo introducendo il concetto di reticolo.
...
Il nome curve ellittiche è dovuto al fatto che sono saltate fuori storicamente nel calcolo della lunghezza di archi di ellisse: data un'ellisse $y^2 = 1 - \alpha x^2$, per calcolare la lunghezza di un arco si giunge a:
\[
	\int \frac{1-b^2 x}{\sqrt{(1-b^2 x) (1-a^2 x)}} \de x,
\]
